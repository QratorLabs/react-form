...
var Base = function (_React$Component) {
  ...
  _createClass(Base, [{
    ...
    value: function render() {
      ...
      var errors = this.getVisibleErrors();

      var errorMessages = errors.filter(function (e) {
      ...
      if (errorMessages.length) {
        errElement = React.createElement(
          ...
          errorMessages.map(function (e, i) {
            var msg = e.msg;
      ...
      var modifiers = [].concat(_toConsumableArray(Object.entries(this.controlState).filter(function (v) {
        return v[1];
      }).map(function (v) {
        return v[0];
      })));
      ...
      var classes = classnames(['q-form-group', this.props.controlClassName].concat(_toConsumableArray(modifiers)));
