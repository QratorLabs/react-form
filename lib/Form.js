...
var Form = function (_React$Component) {
  ...
  _createClass(Form, [{
    ...
    value: function getValue() {
      ...
      try {
        for (var _iterator5 = Object.values(this._controls).map(function (v) {
          return v.name;
    ...
    value: function reset() {
      ...
      try {
        for (var _iterator6 = Object.entries(this._controls)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
    ...
    value: function render() {
      var props = _extends({}, this.props, {
        ...
        className: (0, _classnames2.default)(['q-form', this.props.className])
      });
...
Form.childContextTypes = {
  onControlMount: _propTypes2.default.func,
  onControlUnmount: _propTypes2.default.func,
  onControlChange: _propTypes2.default.func,

  onErrorMount: _propTypes2.default.func,
  onErrorUnmount: _propTypes2.default.func,
