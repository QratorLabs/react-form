...
var _Base = require('./Control/Base');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this._ids = [].concat(_toConsumableArray(this._ids), [_uuid2.default.v4()]);
                if (first) {
                  value = [val].concat(_toConsumableArray(this.value));
                  this._ids = [_uuid2.default.v4()].concat(_toConsumableArray(this._ids));
                }
                change = true;
...
Collection.childContextTypes = {
  ...
  onControlUnmount: _propTypes2.default.func,
  onControlChange: _propTypes2.default.func,
  onControlChangeID: _propTypes2.default.func
};
